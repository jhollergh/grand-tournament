...
public class CongTournament {

    private int rounds;
    private ArrayList<CongBot> botList;
    private boolean selfMatchup;

    public CongTournament(int rd, ArrayList<CongBot> bl, boolean sm) {
        rounds = rd;
        botList = bl;
        selfMatchup = sm;
    }

    public CongTournament(int rd, ArrayList<CongBot> bl) {
        rounds = rd;
        botList = bl;
        selfMatchup = true;
    }
    ...
    public CongTournament(int rd, CongBot b1, CongBot b2) {
        rounds = rd;
        botList = new ArrayList<CongBot>();
        botList.add(b1);
        botList.add(b2);
        selfMatchup = false;
    }
    ...
    public int[][] runTournament() {
        ...
        System.out.println("----------------------");
        System.out.println("                              | Total Sc |    XX    |    XY    |    YX    |    YY    |    WN    |");
        for(int i=0; i < botList.size(); i++) {
